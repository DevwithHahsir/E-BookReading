...
export default function Romantic() {
  ...
  const fetchWarBooksFromAPI = async () => {
    try {
      ...
      const response = await fetch(`${baseUrl}?q=romance`);
    ...
    <>
      <div className="genre-detail-container" data-aos="fade-right">
        ...
        <div className="genre-img">
          <img
            src="https://images.unsplash.com/photo-1496602910407-bacda74a0fe4?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTB8fGNvdXBsZXxlbnwwfHwwfHx8MA%3D%3D"
            alt="img"
          />
